...
/**
 * <p>
 * Domain class cho table CHUONG_MUC
 * </p>
 * 
 * @author ttlang
 *
...
public class Chapter {
	...
	public Chapter(String chapterID, String courseID, String chapterTitle, String chapterContent, String chapterSummary,
		...
		this.listOfLession = listOfLession;
	}
	...
	public List<Lesson> getListOfLession() {
		return listOfLession;
	}

	public void setListOfLession(List<Lesson> listOfLession) {
		this.listOfLession = listOfLession;
	}
	...
	public String toString() {
		return "Chapter [chapterID=" + chapterID + ", courseID=" + courseID + ", chapterTitle=" + chapterTitle
				+ ", chapterContent=" + chapterContent + ", chapterSummary=" + chapterSummary + ", listOfLession="
				+ listOfLession + "]";
	}
